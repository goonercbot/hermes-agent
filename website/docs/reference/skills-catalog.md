...
| [`hermes-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-hermes-agent-skill-authoring) | Use when creating, editing, or retiring Hermes skills. | `software-development/hermes-agent-skill-authoring` |
